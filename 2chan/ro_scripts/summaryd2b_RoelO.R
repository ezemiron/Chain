...
#dir_names <- list.dirs("HCT116_SCC1mAID/2hAAI")
#dir_names <- dir_names[3:length(dir_names)]

var_names <- list.dirs(topPATH, recursive = TRUE, full.names=FALSE)
#var_names <- list.dirs("RO2017-11_03_HCT116_2hAuxin_H3K4me3_H3K27me3_H3K35me3/HCT116_SCC1mAID/2hAAI", full.names=FALSE)
