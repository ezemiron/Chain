  ...
  for (topdir_name in topdir_names){
    ...
    for (dir_name in dir_names){
      ...
      if (length(allfilesandpaths) > 0){
        distnsum  <- grep("*_C488-distn-summary.csv",allfilesandpaths, value = TRUE)
...
#rename
        ...
        savename  <- paste0(con_name,"_C488_distn-compile.csv")
        ...
        savename2 <- paste0(con_name,"_C488_spot-class-compile.csv")
