...
#    df <- transform(df, Log2AvNorm = log2(df$AvNorm))
        ...
        savename  <- paste0(var_name,"_EdU_spot-class-count.csv")
        ...
        savename2  <- paste0(var_name,"_EdU_spot-class-summary.csv")
	...
	savename3 <- paste0(var_name,"_EdU_spot-class-average.csv")
