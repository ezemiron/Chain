...
main <-function (argv)
{
  ...
  segimg.fpath <- argv[3]
  centroidsinv.fpath = gsub("centroids.csv","centroids-inv.csv",centroids.fpath)
...
##    csv2 <- read.csv(centroidsinv.fpath, header=TRUE)
...
##    csv2r <- round (data.frame (csv2[1]/vox[2], csv2[2]/vox[1], csv2[3]/vox[3]))
